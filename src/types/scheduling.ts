...
// Anfitrião (manager) pode LIBERAR e também iniciar/finalizar limpeza quando atribuído
export const STATUS_ALLOWED_ROLES: Record<ScheduleStatus, AppRole[]> = {
  ...
  cleaning: ['admin', 'cleaner', 'manager'], // Manager pode iniciar quando atribuído
  completed: ['admin', 'cleaner', 'manager'], // Manager pode finalizar quando atribuído
};
